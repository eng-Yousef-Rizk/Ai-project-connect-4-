...
class Connect4GUI:
    ...
    def reset_scoreboard(self):
        ...
        self.score_p2 = 0
        self.score_draw = 0
        messagebox.showinfo("Scoreboard Reset", "Scoreboard has been reset.")
    ...
    def reset_board(self):
        # //////// reset board without leaving game mode
        self.board = [[" " for _ in range(COLS)] for _ in range(ROWS)]
        self.turn = 0   # player 1 starts again
        self.draw_board()
